...
import type { Post as _Post, PostAnalytics as _PostAnalytics, UserProfile as _UserProfile, UserRole as _UserRole } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async createPost(arg0: string, arg1: string): Promise<Post> {
        if (this.processError) {
            try {
    ...
    async schedulePost(arg0: bigint, arg1: string): Promise<Post | null> {
        if (this.processError) {
            try {
                const result = await this.actor.schedulePost(arg0, arg1);
                return from_candid_opt_n9(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateAnalytics(arg0: bigint, arg1: bigint, arg2: bigint, arg3: bigint, arg4: bigint, arg5: number): Promise<Post | null> {
        if (this.processError) {
            try {
    ...
    async updatePostCaption(arg0: bigint, arg1: string): Promise<Post | null> {
        if (this.processError) {
            try {
                const result = await this.actor.updatePostCaption(arg0, arg1);
                return from_candid_opt_n9(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updatePostHashtags(arg0: bigint, arg1: Array<string>): Promise<Post | null> {
        if (this.processError) {
            try {
                const result = await this.actor.updatePostHashtags(arg0, arg1);
                return from_candid_opt_n9(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updatePostStatus(arg0: bigint, arg1: string): Promise<Post | null> {
        if (this.processError) {
            try {
...
function from_candid_opt_n9(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_Post]): Post | null {
    return value.length === 0 ? null : from_candid_Post_n3(_uploadFile, _downloadFile, value[0]);
}
function from_candid_record_n4(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        id: value.id,
        status: value.status,
        selectedCaption: value.selectedCaption,
        ...
        optimizedCaption: value.optimizedCaption,
